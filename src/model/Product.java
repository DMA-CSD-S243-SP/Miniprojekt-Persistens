...
/**
 * This class represents a product with details such as ID, name, prices, country of origin,
 * and minimum stock. 
 * 
...
public class Product 
{
     ...
     */
    public Product(int productId, String name, double purchasePrice, double salesPrice, String countryOfOrigin, int minStock) {
